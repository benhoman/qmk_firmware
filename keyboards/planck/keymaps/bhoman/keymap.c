...
[_RAISE] = LAYOUT_planck_grid(
    ...
    XXXXXXX, KC_TILD, KC_HASH, KC_SLSH, KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, KC_BSLS, KC_MINS, KC_EQL,  KC_PIPE,
...
[_SPACE_FN] = LAYOUT_planck_grid(
    ...
    XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,    XXXXXXX,     XXXXXXX, 
    XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX,  _______,  _______,  XXXXXXX, XXXXXXX,  KC__MUTE,   KC__VOLDOWN, KC__VOLUP
),
